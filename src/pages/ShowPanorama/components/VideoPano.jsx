...
const Pano = () => {
  ...
  useEffect(() => {
    ...
    const panorama1 = new PANOLENS.VideoPanorama('/panorama/杨浦滨江-1(1).mp4', {
      autoplay: true,
    });
...
const panorama2 = new PANOLENS.VideoPanorama('/panorama/杨浦滨江-1(2).mp4', {
  autoplay: true,
});
const panorama3 = new PANOLENS.VideoPanorama('/panorama/杨浦滨江-2_1.mp4', {
  autoplay: true,
});
const panorama4 = new PANOLENS.VideoPanorama('/panorama/杨浦滨江-2.mp4', {
  autoplay: true,
});
