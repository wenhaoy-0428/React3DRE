...
import { openViewer_N2M } from '../../services/ant-design-pro/api';
...
const Viewer_N2M = () => {
  ...
  return (
    <>
    <div id="container" style={{display:"flex", justifyContent:"cneter", alignItems:"center"}} ref={containerRef}></div>
